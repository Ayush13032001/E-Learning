...
export const bannerStyles = {
  ...
  // Heading (UPDATED)
  heading:
    "text-3xl sm:text-4xl lg:text-5xl font-sans font-extrabold tracking-tight leading-tight",

  headingSpan1:
    "block text-transparent bg-clip-text \
   bg-gradient-to-r from-red-500 via-yellow-400 to-blue-500 \
   bg-[length:200%_200%] animate-rainbow",

  headingSpan2:
    "block text-transparent bg-clip-text \
   bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 \
   bg-[length:200%_200%] animate-rainbow delay-300",
  ...
  featureIcon: "text-sm",
  featureText: "text-gray-700 font-sans text-sm sm:text-base",
...
export const homeCoursesStyles = {
  ...
  // Course Card
  courseCard:
    "cursor-pointer group transition-transform duration-300 ease-out hover:scale-[1.05]",
  imageContainer: "relative rounded-2xl xl:rounded-2xl overflow-hidden",
  courseImage:
    "w-full object-cover h-48 sm:h-48 md:h-40 lg:h-48 transition-transform duration-300 ease-out group-hover:scale-110",
  // Course Info
  courseInfo:
