        ...
        <div className={bannerStyles.grid}>
          <div className={bannerStyles.leftContent}>
            ...
            <h1 className={bannerStyles.heading}>
              <span className={bannerStyles.headingSpan1}>Welcome</span>
              <span className={bannerStyles.headingSpan2}>
                Discover new learning
              </span>
            </h1>
            <p className={bannerStyles.description}>
              Build real-world projects, crack top tech interviews, and launch
              your dream career with our premium, hands-on coding courses.
            </p>
            <div className={bannerStyles.featuresGrid}>
              {features.map((feature, index) => (
                <div key={index} className={bannerStyles.featureItem}>
